...
<body class="bg-oldschool-bg min-h-screen flex items-center justify-center py-12">
    <div class="max-w-md w-full mx-auto p-6">
        ...
        <div class="text-center mb-8 bg-white old-border p-4">
            ...
            <p class="text-oldschool-text mt-2 border-t border-oldschool-border pt-2">Create your pet lover account</p>
        ...
        <div class="bg-white old-border p-8">
            <h2 class="text-2xl font-bold text-center text-oldschool-text mb-6 old-title border-b-2 border-oldschool-border pb-2">Create an Account</h2>
            
            <?php if (isset($registerError)): ?>
            <div class="old-error mb-4">
                <div class="flex items-center">
                    <i class="fas fa-exclamation-triangle mr-2 text-primary"></i>
                    <span class="text-oldschool-text font-bold"><?php echo $registerError; ?></span>
                </div>
            </div>
            <?php endif; ?>
            ...
            <form action="register.php" method="POST">
                ...
                <div class="mb-4">
                    <label for="email" class="block text-oldschool-text text-sm font-bold mb-2">Email:</label>
                    <div class="flex items-center old-border bg-oldschool-bg p-1">
                ...
                <div class="mb-6">
                    <label for="confirm_password" class="block text-oldschool-text text-sm font-bold mb-2">Confirm Password:</label>
                    <div class="flex items-center old-border bg-oldschool-bg p-1">
                        <i class="fas fa-lock text-primary mx-2"></i>
                ...
                <div class="mb-6 border-t border-b border-oldschool-border py-3">
                    <div class="flex items-center">
                        <input type="checkbox" id="terms" name="terms" class="old-checkbox">
                        <label for="terms" class="ml-2 block text-sm text-oldschool-text">
                            I agree to the <a href="<?php echo SITE_URL; ?>/pages/user/terms.php" class="old-link">Terms and Conditions</a>
                        </label>
                    </div>
                </div>
        ...
        <div class="text-center mt-4 bg-white old-border p-3">
            <p class="text-oldschool-text">
                Already have an account? <a href="login.php?type=user" class="old-link">Login</a>
            </p>
        </div>
    </div>
</body>
